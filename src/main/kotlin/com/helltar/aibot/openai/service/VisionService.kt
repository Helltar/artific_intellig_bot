...
class VisionService(private val apiClient: ApiClient = ApiClient, private val model: String) {
    ...
    suspend fun analyzeImage(text: String, image: File): String {
        ...
        val response: VisionResponseData = apiClient.post(Endpoints.CHAT_COMPLETIONS, request)
