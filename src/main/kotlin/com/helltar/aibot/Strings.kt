...
object Strings {
    ...
    const val UPDATE_API_KEYS_COMMAND_EXAMPLE = "ℹ\uFE0F Example: <code>/$CMD_UPDATE_API_KEY sk-key_here</code> for <b>OpenAI</b>, <code>/$CMD_UPDATE_API_KEY $PROVIDER_DEEPSEEK sk-key_here</code> for <b>DeepSeek</b>" // ℹ️
